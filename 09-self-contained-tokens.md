...
| **9.2.5** | Verify asymmetric signatures (RS256/ES256) preferred over HMAC | ✓ | ✓ | SC-13 | Key separation |
| **9.2.6** | Verify key ID (kid) validation to prevent key confusion attacks | ✓ | ✓ | SC-13 | Algorithm confusion prevention |
| **9.2.7** | Verify JWT "none" algorithm rejected | ✓ | ✓ | SC-13 | Auth bypass prevention |
